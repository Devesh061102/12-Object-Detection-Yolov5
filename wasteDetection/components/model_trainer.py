...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,) -> ModelTrainerArtifact:
        ...
        try:
            ...
            os.system("wsl unzip data.zip")
            os.system("wsl rm data.zip")
            ...
            os.system("wsl rm -rf yolov5/runs")
            os.system("wsl rm -rf train")
            os.system("wsl rm -rf valid")
            os.system("wsl rm -rf data.yaml")
